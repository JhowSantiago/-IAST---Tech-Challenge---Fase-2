...
O código-fonte está em [`pipeline-alfabetizacao/`](pipeline-alfabetizacao/).
...
Detalhes técnicos: [arquitetura.md](pipeline-alfabetizacao/docs/arquitetura.md) | [decisoes-arquiteturais.md](pipeline-alfabetizacao/docs/decisoes-arquiteturais.md)

---

## 4. Diagrama da pipeline

![Diagrama da pipeline](pipeline-alfabetizacao/docs/diagrama-pipeline.png)
...
2. Staging local em Parquet (`pipeline-alfabetizacao/data/staging/`)
...
Mais detalhes: [decisoes-arquiteturais.md](pipeline-alfabetizacao/docs/decisoes-arquiteturais.md)

---

## 8. Monitoramento

- **Logs estruturados** nos jobs Glue (`pipeline-alfabetizacao/src/common/logging.py`) com contexto de job, entidade e camada
...
Documentação completa: [finops.md](pipeline-alfabetizacao/docs/finops.md)
...
Documentação de deploy: [deploy-aws.md](pipeline-alfabetizacao/docs/deploy-aws.md)
...
| Documento | Conteúdo |
|-----------|----------|
| [Arquitetura](pipeline-alfabetizacao/docs/arquitetura.md) | Fluxo detalhado e componentes AWS |
